    ...
    <>
      ...
      >
        <div className="content">
          <h2 style={{fontFamily:"Urbanist"}}>Contact us:</h2>
        </div>
        <div
          className="box"
          style={{
        ...
        >
          ...
          <strong style={{fontFamily:"Urbanist"}}>
            Email: <span style={{fontFamily:"Urbanist"}}>contactnskmeditech@gmail.com</span>
          </strong>
        </div>
        ...
        >
          ...
          <strong style={{fontFamily:"Urbanist"}}>
            Address: <span style={{fontFamily:"Urbanist"}}>411,Thiyagaraya New Street,Coimbatore</span>
          </strong>
        </div>
        {/* <p style={{
            fontFamily:"Urbanist",
